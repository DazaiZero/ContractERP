...
export const CompletedSite = (props) => {
  return (
    <View style={styles.container}>
      <View style={styles.backGroundMain1}>
        <View style={styles.headerCommon1}>
          ...
          <Text style={styles.siteCompleted}>Site Completed</Text>
            ...
            >
                ...
                <View style={styles.siteImagesButtonStack}>
                  ...
                  <View style={styles.finish}>
                    <View style={styles.rect9}>
                      <Text style={styles.finishDate}>Finish Date</Text>
                      <Text style={styles.pune4}>01 May 2023</Text>
                    </View>
                  </View>
                </View>
              </TouchableOpacity>
              <TouchableOpacity style={styles.supervisorCard2}>
                <View style={styles.imagesButtonStack}>
                  ...
                  <View style={styles.finish1}>
                    <View style={styles.rect10}>
                      <Text style={styles.finishDate1}>Finish Date</Text>
                      <View style={styles.pune5Stack}>
                        <Text style={styles.pune5}>01 May 2023</Text>
                        <Text style={styles.text14}>01 May 2023</Text>
                      </View>
                    </View>
                  </View>
                </View>
              ...
              <TouchableOpacity style={styles.supervisorCard3}>
                <View style={styles.imagesBtnStack}>
                  ...
                  <View style={styles.finish2}>
                    <View style={styles.rect11}>
                      <Text style={styles.finishDate2}>Finish Date</Text>
                      <View style={styles.pune6Stack}>
                        <Text style={styles.pune6}>01 May 2023</Text>
                        <Text style={styles.text15}>01 May 2023</Text>
                      </View>
                    </View>
                  </View>
                </View>
