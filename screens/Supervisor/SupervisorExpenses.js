...
export const SupervisorExpenses = ({ route, navigation }) => {
  ...
  const TrData = [
    { id: 1, date: "01-05-2022", opt: "Received", amount: "2000" },
    { id: 2, date: "04-05-2022", opt: "Expense", amount: "1300" },
    { id: 3, date: "06-05-2022", opt: "Received", amount: "2500" },
    { id: 4, date: "11-05-2022", opt: "Expense", amount: "10406" },
    { id: 5, date: "20-05-2022", opt: "Received", amount: "600" },
    { id: 6, date: "23-05-2022", opt: "Received", amount: "400" },
    { id: 7, date: "24-05-2022", opt: "Expense", amount: "6300" },
    { id: 8, date: "25-05-2022", opt: "Received", amount: "8200" },
    { id: 9, date: "25-05-2022", opt: "Expense", amount: "10200" },
    { id: 10, date: "26-05-2022", opt: "Received", amount: "12000" },
    { id: 11, date: "01-06-2022", opt: "Expense", amount: "35000" },
    { id: 12, date: "02-06-2022", opt: "Received", amount: "22000" },
    { id: 13, date: "05-06-2022", opt: "Received", amount: "24000" },
    { id: 14, date: "10-06-2022", opt: "Expense", amount: "23000" },
    { id: 15, date: "17-06-2022", opt: "Received", amount: "3000" },
  ];
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.containerEntry}>
          <View style={styles.addMaterialModal1Entry}>
            ...
            <View style={styles.paidSelectRowEntry}>
              ...
              >
                <Text style={styles.paidEntry}>Received</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
      ...
      <View style={styles.headerCommon1}>
        ...
        <Text style={styles.addNewSite}>Supervisor Expense</Text>
      </View>
      <View style={styles.rect5}>
        <View style={styles.pendingAmtGrp1Row}>
          <View style={styles.pendingAmtGrp1}>
            <Text style={styles.totalAllotted}>Total Received</Text>
        ...
        <View style={styles.rect2Row}>
          ...
          <View style={styles.rect3}>
            <Text style={styles.allotExp5}>Entry</Text>
          </View>
