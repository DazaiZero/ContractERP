...
export const BuilderSupplierTransactions = ({ route, navigation }) => {
  ...
  const TrData = [
    { id: 1, date: "01-05-2022", opt: "Paid", amount: "2000" },
    { id: 2, date: "04-05-2022", opt: "Purchase", amount: "1300" },
    { id: 3, date: "06-05-2022", opt: "Paid", amount: "2500" },
    { id: 4, date: "11-05-2022", opt: "Purchase", amount: "10406" },
    { id: 5, date: "20-05-2022", opt: "Paid", amount: "600" },
    { id: 6, date: "23-05-2022", opt: "Paid", amount: "400" },
    { id: 7, date: "24-05-2022", opt: "Purchase", amount: "6300" },
    { id: 8, date: "25-05-2022", opt: "Paid", amount: "8200" },
    { id: 9, date: "25-05-2022", opt: "Purchase", amount: "10200" },
    { id: 10, date: "26-05-2022", opt: "Paid", amount: "12000" },
    { id: 11, date: "01-06-2022", opt: "Purchase", amount: "35000" },
    { id: 12, date: "02-06-2022", opt: "Paid", amount: "22000" },
    { id: 13, date: "05-06-2022", opt: "Paid", amount: "24000" },
    { id: 14, date: "10-06-2022", opt: "Purchase", amount: "23000" },
    { id: 15, date: "17-06-2022", opt: "Paid", amount: "3000" },
  ];
  ...
  return (
    <View style={styles.container}>
        ...
        <View style={styles.containerEntry}>
          <View style={styles.addMaterialModal1Entry}>
            ...
            <View style={styles.paidSelectRowEntry}>
              ...
              >
                <Text style={styles.paidEntry}>Paid</Text>
              </TouchableOpacity>
              <TouchableOpacity
                style={[
              ...
              >
                <Text style={styles.purchaseEntry}>Purchase</Text>
              </TouchableOpacity>
            </View>
            <TouchableOpacity
      ...
      <View style={styles.headerCommon1}>
        ...
        <Text style={styles.addNewSite}>BuilderSupplier Details</Text>
      </View>
      <View style={styles.rect5}>
        <View style={styles.button2Row}>
          ...
          >
            <Text style={styles.makeEntry}>Make Entry</Text>
          </TouchableOpacity>
          {!PageType ? (
            <View style={styles.pendingAmtGrp1}>
              <Text style={styles.pendingAmount3}>Pending Amount</Text>
        ...
        <View style={styles.dateHedRow}>
          <View style={styles.dateHed}>
            <Text style={styles.date}>Date</Text>
          </View>
          <View style={styles.opHed}>
            <Text style={styles.operation}>Operation</Text>
          </View>
          <View style={styles.amountHed}>
            <Text style={styles.amount4}>Amount</Text>
          </View>
        </View>
      </View>
                  ...
                  <View style={styles.rect8}>
                    <View style={styles.dateGrpRow}>
                      ...
                      <View style={styles.detailGrp}>
                        <Text style={styles.paidPurch}>{item.item.opt}</Text>
                      </View>
      ...
      <View style={styles.shareGrpRow}>
        <TouchableOpacity
          style={[
            styles.shareGrp,
            {
              backgroundColor: PageType ? "rgba(80,227,194,1)" : "#E6E6E6",
            },
          ]}
          onPress={() => {
            setPageType(1);
        ...
        >
          <Text style={styles.sitewise}>Sitewise</Text>
        </TouchableOpacity>
        <TouchableOpacity
          style={[
            styles.saveGrpButton,
            {
              backgroundColor: PageType ? "#E6E6E6" : "rgba(80,227,194,1)",
            },
          ]}
          onPress={() => {
            setPageType(0);
        ...
        >
          <Text style={styles.pending2}>Pending</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
